...
8. Получить список регулярных игроков.
    ...
    Параметры:
      -player_type  — тип игрока: 1 - регулярный, 0 - нерегулярный, 2 - забаненый
...
16. Получить статистику по игрокам.
    ...
    Бот вернёт в личном сообщении список игроков и количество участий игрока в кворуме за last_games опросов. В статистике учасвуют опросы типов RFR_GAME и RFR_GAME2. 
