...
1.a)  /game game_cost|max_players|заголовок|кнопка_да|кнопка_нет|кнопка_?|кнопка_+|кнопка_-
1.b)  /single заголовок|кнопка_1|...|кнопка_N
1.c)  /multi заголовок|кнопка_1|...|кнопка_N
1.d)  /game2 game_cost|max_players|заголовок|кнопка_да|кнопка_нет|кнопка_?|кнопка_+|кнопка_-|дополнительная_кнопка
2.    /get status*
3.    /close msg_id*
4.    /open msg_id
5.    /update msg_id|game_cost|max_players|заголовок|кнопка_1|...|кнопка_N
6.    /add_btn msg_id|кнопка
7.    /log msg_id*
8.    /get_reg
9.    /set_reg user_id|player_type
10.   /del_reg user_id_1|user_id_2|...|user_id_N
11.   /get_silent msg_id*
12.   /notify msg_id*|текст
13.   /notifyq msg_id*|текст
...
1. Создать опрос.
  ...
  Виды опросов:
    a) Опрос на игру. Пять кнопок (да, нет, ?, +друг, -друг). Выбирать можно только один вариант из трёх кнопок (да, нет, ?); кнопками +друг и -друг можно указать количество твоих друзей, кто придёт с тобой на игру.
        ...
        -Total confirmed — количество игроков, проголосовавших положительно
        -Entry fee — стоимость игры на одного игрока. Выводится, если указана общая стоимость игры game_cost
        -Free slots left — количество свободных мест. Выводится, если указано максимальное количество игроков max_players
        -Extra people — количество игроков в очереди. Выводится, если указано максимальное количество игроков max_players и оно было достигнуто
        -Next candidate — первый игрок из очереди. Выводится, если указано максимальное количество игроков max_players и оно было достигнуто
        -Regular players — постоянные игроки. Выводится, если используется учёт постоянных игроков (см. п.7 и п.8)
        -Other players — непостоянные игроки. Выводится, если используется учёт постоянных игроков (см. п.7 и п.8)
    ...
    d) Опрос на игру. Тоже, что и в п. a), но присутствует дополнительная кнопка для второстепенного опроса
        ...
        Команда:
          /game2 game_cost|max_players|заголовок|кнопка_да|кнопка_нет|кнопка_?|кнопка_+|кнопка_-|дополнительная_кнопка
...
8. Получить список регулярных игроков.
    ...
    {-100<id группы>(<название группы>), user_id = <id пользователя Telegram>, player_type}
...
9. Добавить игрока в список регулярных игроков.
    ...
    Параметры:
      ...
      -player_type  — тип игрока: 1 - регулярный, 0 - нерегулярный
...
11. Получить список непроголосовавших участников группы.
    Команда:
      /get_silent msg_id*
...
12. Уведомить участников группы, не отметившихся в опросе.
    Команда:
      /notify msg_id*|текст
...
13. Уведомить участников группы, нажавших в опросе вида 1.a) и 1.d) кнопку "?".
    Команда:
