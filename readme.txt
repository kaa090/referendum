БОТЯРА состоит из следующих файлов:
...
6. Добавить кнопку в существующий опрос.
    Команда:
    ...
    Добавить кнопки можно только в простой опрос и опрос с множественным выбором кнопок.
